...
<li  class="editor nav <logic:notEmpty name="uuid" scope="request"><logic:notEqual name="uuid" scope="request" value="new">valid</logic:notEqual></logic:notEmpty>" ><a href="${pageContext.request.contextPath}/panel/photo/${langCode}/${photo.uuid}/view.html" id="preview-editor-btn" target="_blank" ><i class="icon solid fa-eye"></i><bean:message key="btn.preview" bundle="ae21studio" /></a></li>
