...
<div class="row gtr-25">
        ...
        <logic:iterate id="uPhoto" name="userPhotoList" scope="request" indexId="seq">
            <logic:notEmpty name="uPhoto">
                <div class="col-3 col-4-large col-3-medium col-3-small">
                    <a href="#" class="alt photo-album" onclick="addItem('photo', '${uPhoto.uuid}');return false;">
                        ...
                        <logic:equal name="uPhoto" property="productCreateMethod" value="2">
                         ...
                         <logic:equal name="uPhoto" property="productCreateMethod" value="3">
                                    <img src="${pageContext.request.contextPath}${uPhoto.productUrl}" class="images fit" />
                                </logic:equal>
                    </a>
                </div>
    ...
    <div class="col-12">
        <div class="search_footer">
            ...
            <logic:notEmpty name="SEARCH_EDITOR_FOLDER_RESULT" scope="session" >
                <logic:notEqual name="SEARCH_EDITOR_FOLDER_RESULT" property="curPage" scope="session" value="0">
                    <a href="#" onclick="folderSearchPage(${(SEARCH_EDITOR_FOLDER_RESULT.curPage-1)});return false;"; class="button primary"><bean:message key="btn.previous" bundle="ae21studio"/></a>
                </logic:notEqual>


                <logic:lessThan name="SEARCH_EDITOR_FOLDER_RESULT" property="curPage" scope="session" value="${(SEARCH_EDITOR_FOLDER_RESULT.page-1)}">
                    <a href="#" onclick="folderSearchPage(${(SEARCH_EDITOR_FOLDER_RESULT.curPage+1)});return false;";  class="button primary"><bean:message key="btn.next" bundle="ae21studio"/>  </a>
                </logic:lessThan>
            </logic:notEmpty>
            </logic:empty>
                <logic:empty name="isEditorFolder">
