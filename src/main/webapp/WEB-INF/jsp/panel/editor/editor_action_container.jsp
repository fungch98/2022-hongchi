...
<ul class="editor-menu-action">
    ...
    <li><a href="#" onclick="editorSave('Y');return false;"><img src="${pageContext.request.contextPath}/images/icon/close.png"/><p><bean:message key="btn.savenexit" bundle="ae21studio" /></p></a></li>
</ul>