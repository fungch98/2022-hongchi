 ...
 *   https://datatables.net/download/#dt/dt-1.10.23/fc-3.3.2/fh-3.1.7/r-2.2.6/sp-1.2.2
 *
 * Included libraries:
 *   DataTables 1.10.23, FixedColumns 3.3.2, FixedHeader 3.1.7, Responsive 2.2.6, SearchPanes 1.2.2
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"dt/dt-1.10.23/fc-3.3.2/fh-3.1.7/r-2.2.6/sp-1.2.2",
